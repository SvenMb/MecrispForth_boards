\ ---
\ subject: register definitions for stm32f4
\ ---

( register_def start: ) here dup hex.
...
OTG_FS_GLOBAL $20 + constant OTG_FS_GLOBAL_FS_GRXSTSP
...
OTG_FS_GLOBAL $28 + constant OTG_FS_GLOBAL_FS_DIEPTXF0
...
( register_def end: ) here dup hex.
( register_def size: ) swap - hex.
